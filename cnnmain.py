...
# model
model = load_model('source_code/src/model/best_model_v2.h5')
...
while True:
    ...
    cv2.putText(img_original, "Dat bien bao vao day", (x_start, y_start - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 0), 2)
